...
import type { Options, MessageIds } from '../../src/rules/no-node-access';
import type {
	InvalidTestCase,
	ValidTestCase,
...
ruleTester.run(rule.name, rule, {
	valid: [
      ...
      `,
				...
				* now all node accessing properties (listed in src/utils/index.ts, in PROPERTIES_RETURNING_NODES)
