...
| [no-test-id-queries](docs/rules/no-test-id-queries.md)                           | Ensure no `data-testid` queries are used                                                     | ![badge-angular][] ![badge-dom][] ![badge-marko][] ![badge-react][] ![badge-svelte][] ![badge-vue][] |                                                                                       |     |
